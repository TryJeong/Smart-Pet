...
const char* ssid = "Shingu_NG_111";
const char* password = "shinguwifi";

const int MQ136pin = A0; // MQ-136 센서의 아날로그 핀 번호
const int MQ137pin = A0; // MQ-137 센서의 아날로그 핀 번호 (다른 핀으로 변경)

const char* host = "192.168.233.222"; // 데이터를 보낼 서버 주소
...
void sendSensorDataToServer(float value1, float value2) {
  // 서버 주소 설정
  String url = "http://192.168.233.222/your_php_script.php"; // 여기서 'your_php_script.php'를 수정해야 합니다.
